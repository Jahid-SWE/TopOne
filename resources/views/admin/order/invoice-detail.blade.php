        ...
        <div class="col-md-12">
            <div style="width: 90%">
                <header>
                    <h1>Invoice</h1>
                    <address>
                        <h3 style="font-size:20px; border-bottom: 2px dotted gray; margin-bottom: 10px;">Billing Info</h3>
                        <hr/>
                        <p>{{$customer->name}}</p>
                    ...
                    <address style="float: right">
                        <h3 style="font-size:20px; border-bottom: 2px dotted gray; margin-bottom: 10px;">Shipping Info</h3>
                        <hr/>
                        <p>{{$shipping->name}}</p>
                ...
                <article>
                    ...
                    <table class="meta">
                        ...
                        <tr>
                            ...
                            <td><span id="prefix">TK.</span><span>{{number_format($order->order_total)}}</span></td>
                        </tr>
                    </table>
