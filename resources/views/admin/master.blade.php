...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('manage-user') }}">Manage User</a>
                    </div>
                </div>
            </li>
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('view-subscribers')}}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>View Subscriber lists</span>
                </a>
            </li>
