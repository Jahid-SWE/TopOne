            ...
            <div class="col-md-12">
               <div class="panel panel-body">
                <h2 class="text-center" style="margin-bottom: 40px;">{{ Session::get('message') }}</h2>
                   <h2 class="text-center" style="margin-bottom: 40px;">All Cart Product Info Goes Here.</h2>
                    ...
                    <table class="table table-bordered" style="width: 40%; margin-left: 59%; border: 1px solid lightgray">
                        <tr>
                            <th>Sub Total</th>
